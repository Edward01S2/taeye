        ...
        <div className="flex justify-between items-center m-200">
          ...
          >
            <div className="uppercase tracking-wide">
              ...
              <Link className="navbar-item pl-8" to="/products">
                Products
              </Link>
              <Link className="navbar-item pl-8" to="/blog">
                Blog
              </Link>
            </div>
          </div>
            <Link className="bg-ta-blue absolute pin-t pin-r h-full px-8 flex items-center text-white uppercase tracking-wide" to="/contact">
              Appointments
            </Link>
          </div>
